...
# Porcelain
The more "user friendly" commands intended to be used as the main API to manipulate GIT
...
# Plumbing
Generally subcommands that do low level work and were designed to be chained in scripts or indirectly invoked via porcelain commands
...
Command aliases
   ...
   slog                    log --format=oneline --abbrev-commit
   st                      status
   stat                    status
   xsl                     xslog
   xslog                   log --format=oneline --abbrev-commit --name-status
